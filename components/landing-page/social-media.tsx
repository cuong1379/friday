...
const SocialMedia = () => {
  return (
    <>
      <div className="dark fixed right-10 top-[30%] z-50 hidden -translate-y-[30%] flex-col items-center justify-center gap-2 rounded-[10px] border border-white border-opacity-[0.08] bg-white bg-opacity-[0.02] p-1 backdrop-blur-md lg:flex">
        <a
          target="_blank"
        ...
        >
          ...
          <span className="sr-only">Join our facebook community</span>
        </a>
        <a
          target="_blank"
        ...
        >
          ...
          <span className="sr-only">Join our reddit community</span>
        </a>
        <a
          target="_blank"
        ...
        >
          ...
          <span className="sr-only">Join our instagram community</span>
        </a>
      </div>
    </>
  );
